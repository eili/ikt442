# Yolo-v3 and Yolo-v2 for Windows
This version is a clone of the version from AlexeyAB. It was used for a vido analysis project at seminar 3, UIA.

The rest of the Readme is a copy of the original, cloned from https://github.com/AlexeyAB/darknet:
