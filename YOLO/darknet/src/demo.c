...
void *detect_in_thread(void *ptr)
{
	...
	//For fallen person detection:
	draw_detections_cv_v4(det_img, dets, nboxes, demo_thresh, demo_names, demo_alphabet, demo_classes, demo_ext_output, "person");
